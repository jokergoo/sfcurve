...
Generate nxn curve based on a specific level-1 unit:
...
- `sfc_nxn`: the base class for the general nxn curve
...
The UML of classes and their corresponding methods implemented in this package.
