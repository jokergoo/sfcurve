...
```{r, fig.width = 9, fig.height = 3}
p2 = sfc_flip_unit(p, "73") # the most topright 3x3 unit 
...
As has already shown in the vignette ["Generalized Peano Curve"](peano_curve.html), `sfc_peano()` accepts
...
sfc_peano("IJ", level = 3, rot = 90, flip = function(p) {
    p@rot %in% c(90, 270)
}) |> plot()
```
